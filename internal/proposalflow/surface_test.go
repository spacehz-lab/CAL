...
func TestNormalizeSurfacesAppliesDefaultsAndTrim(t *testing.T) {
...
func TestNormalizeSurfacesDropsSkippedDeferredAndDisallowedKinds(t *testing.T) {
...
func TestNormalizeSurfacesSkipsNamesAndPatterns(t *testing.T) {
	policy := DefaultPolicy()
...
func TestNormalizeSurfacesAppliesMaxSurfaceItems(t *testing.T) {
	items, _, err := normalizeSurfaces([]surface{
...
func TestNormalizeSurfacesAcceptsOptionSurface(t *testing.T) {
	items, _, err := normalizeSurfaces([]surface{{
		ID:       "s1",
		Kind:     "option",
		Name:     "--encode",
